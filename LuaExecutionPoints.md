...
## Execution Points
1. [Unit Activation](#unit-activation)
2. [Unit Bribery](#unit-bribery)
3. [City Yield Calculation](#city-yield-calculation)
3. [Checking Production Availability](#checking-production-availability)
...
3. [Key Press](#key-press)
3. [On Load](#on-load)
3. [On Save](#on-save)
3. [Scenario Loaded](#scenario-loaded)
3. [Negotiation](#negotiation)
3. [Schism](#schism)
3. [Between Turns](#between-turns)
3. [Unit Killed In Combat](#unit-killed-in-combat)

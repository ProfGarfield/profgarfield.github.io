...
Generally speaking, when a Civ II game mechanic needs a distance measure of some sort, it will use an approximation of this calculation.  However, you have probably noticed
